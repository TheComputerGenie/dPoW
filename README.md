...
Integration | Status 
-------------|------
CI build - Ubuntu (20.04, 22.04) | [![Build Status](https://github.com/thecomputergenie/dpow/workflows/CI/badge.svg?maxAge=60)](https://github.com/thecomputergenie/dPoW/actions)
